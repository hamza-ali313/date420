...
<style>
.mpl_table.mpl_top table tbody tr:first-child th,
.mpl_table.mpl_top table tbody tr:first-child td {
    padding-bottom: 20px;
}

.mpl_table.mpl_top table tbody tr:first-child h4 {
    font-size: 21px;
}

.mpl_table.mpl_top table tbody tr:first-child h5 {
    font-size: 20px;
}
            ...
            <div class="col-12">
                <nav class="ds_tabs">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link active" id="nav-my-match-tab" data-bs-toggle="tab"
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-my-match" role="tabpanel"
                        aria-labelledby="nav-my-match-tab" tabindex="0">
                        <div class="profile_section user_myMatches">
                            <div class="container">
                                <div class="row">
                                            ...
                                            <div class="mp_left">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <img src="images/user_prof.png" class="img-fluid" alt="profile">
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="mpl_table mpl_top">
                                ...
                                <div
                                    class="d-flex align-items-start mt-3 mt-sm-0 align-items-sm-center flex-column flex-sm-row gap-2 gap-sm-4">
                                    <!-- <a href="dashboard_chat.php" class="btn-theme2 mt-5"><i
                                            class="fa-regular fa-comment-dots"></i>Start Chatting</a> -->
                                    <a href="dashboard_chat.php" class=" mt-1 mt-sm-5">
                                        <div class="button-container-2 my_match_btn2 me-0">
                                            <span class="mas"><i class="fa-regular fa-comment-dots"></i>Start
                                                Chatting</span>
                                            <button type="button" name="Hover"><i
                                                    class="fa-regular fa-comment-dots"></i>Start Chatting</button>
                                        </div>
                                    </a>
                                    <a href="javascript:;" class="btn-theme2 mt-1 mt-sm-5 hotlist-toggle">
                                        <i class="fa-regular fa-heart"></i>Add to Hotlist
                                    </a>
                                </div>
                            </div>
                        </div>
