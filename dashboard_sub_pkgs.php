            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-subcribe" role="tabpanel"
                        ...
                        <div class="search_dashboard subcribe subscription">
                            <h2>Subscription Packages</h2>
                            <div class="sd_inner_subcribtions">
                                <div class="row justify-content-center">
                                    <div class="col-12 col-lg-10">
                                        <div class="row justify-content-center">
                                            <div class="col-12 col-sm-8 col-md-6">
                                                <div
                                                    class="sis_card sis_card_left d-flex flex-column justify-content-between">
                                                    <div>
                                                        <div class="sis_card_top d-flex justify-content-between ">
                                                            <h3>Trial - 1 month</h3>
                                                            <div class="sct_token">
                                                                <h3>Free</h3>
                                                            </div>
                                                        </div>
                                                        <div class="sis_card_mid">
                                                            <ul>
                                            ...
                                            <div class="col-12 col-sm-8 col-md-6">
                                                <div
                                                    class="sis_card sis_card_right  d-flex flex-column justify-content-between">
                                                    <div>
                                                        <div class="sis_card_top d-flex justify-content-between ">
                                                            <h3>1 month Package</h3>
                                                            <div class="sct_token">
                                                                <h3>$4.<span>20</span></h3>
                                                            </div>
                                                        </div>
                                                        <div class="sis_card_mid">
                                                            <ul>
                                        ...
                                        <div class="row justify-content-center justify-content-md-start mt-3">
                                            <div class="col-12 d-flex align-items-center align-items-sm-start col-sm-3">
                                                <a href="dashboard_subcription.php"
                                                    class="back_search button-container-2 d-inline-flex">
                                ...
                                <div class="col-12 col-sm-8 col-md-8 col-xl-9 ps-0 ps-md-4">
                                    <div class="chat-right" id="v-pills-tabContent">
                                        ...
                                        <div class="chat-right-scroll fade" id="v-pills-profile3" role="tabpanel"
                                            ...
                                            <div class="cr-1 cr-group d-flex align-items-center justify-content-between">
                                                <div class="d-flex gap-0 gap-md-3 flex-md-row flex-column align-item-md-center align-items-start">
                                                    <!-- <img src="images/pic2.svg" alt=""> -->
                                                    <h3>Group 1</h3>
